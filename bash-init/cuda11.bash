...
source $HOME/dev/nvidia/switch-cuda/switch-cuda.sh 11.0
...
export PATH="$PATH:$HOME/bin:/usr/local/cuda-11.0/bin:$HOME/dev/nvidia/switch-cuda"
...
export LD_LIBRARY_PATH="$HOME/raid/02-dev/nvidia/tensorrt/TensorRT-7.2.0.14/lib:$LD_LIBRARY_PATH"

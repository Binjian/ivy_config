...
source /home/x/dev/nvidia/switch-cuda/switch-cuda.sh 9.2
...
# # sudo ln -s /media/x/5c4898a9-1bf9-45a0-abe9-f1be82c92b35 /mnt/raid12t

export PATH="$PATH:$HOME/bin:/usr/local/cuda-9.2/bin:/home/x/dev/nvidia/switch-cuda"
...
export LD_LIBRARY_PATH="/home/x/dev/nvidia/TensorRT/TensorRT-5.0.2.6/lib:$LD_LIBRARY_PATH"

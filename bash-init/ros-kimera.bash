...
export OPENCV_ROOT="$HOME/raid/02-dev/cv/opencv/3.4.11/opencv-install-g7c101"
export LD_LIBRARY_PATH="$HOME/raid/02-dev/cv/opencv/3.4.11/opencv-install-g7c101/lib:$LD_LIBRARY_PATH"
export PATH="$HOME/raid/02-dev/cv/opencv/3.4.11/opencv-install-g7c101/bin:$PATH"

...
export OPENCV_ROOT="$HOME/raid/02-dev/cv/opencv/3.4.10/opencv-3.4.10-install-g5c9"
export LD_LIBRARY_PATH="$HOME/raid/02-dev/cv/opencv/3.4.10/opencv-3.4.10-install-g5c9/lib:$LD_LIBRARY_PATH"
export PATH="$HOME/raid/02-dev/cv/opencv/3.4.9/opencv-3.4.10-install-g5c9/bin:$PATH"

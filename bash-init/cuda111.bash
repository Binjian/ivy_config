...
source $HOME/bash-init/switch-cuda/switch-cuda.sh 11.1
...
export PATH="/bin:/usr/bin:/usr/local/bin:${PATH}:/usr/local/cuda-11.1/bin"
...
export LIBRARY_PATH="/usr/local/cuda-11.1/lib64:/usr/local/cuda-11.1/extras/CUPTI/lib64:$LIBRARY_PATH"
export LIBRARY_PATH="/vault/Downloads/nvidia/11.1/TensorRT-7.2.1.6/lib:$LIBRARY_PATH"
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/vault/Downloads/nvidia/11.1/TensorRT-7.2.1.6/lib:/usr/local/cuda-11.1/extras/CUPTI/lib64"
export CPATH="/usr/local/cuda-11.1/lib64:/usr/local/cuda-11.1/include:$CPATH"

# export CUDA_ROOT=/usr/local/cuda-11.1

export CUDA_INSTALL_DIR=CUDA_ROOT
export CUDNN_INSTALL_DIR=CUDA_ROOT
export TRT_LIB_DIR="$HOME/Downloads/nvidia/11.1/TensorRT-7.2.1.6"
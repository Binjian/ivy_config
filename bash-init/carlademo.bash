...
export UE4_ROOT=~/devel/sim/carla/UnrealEngine

# export CARLA_SERVER=/home/is/devel/sim/carla/carla-0.9.6/CarlaUE4.sh

# export CARLA_ROOT=/home/is/devel/sim/carla/carla-0.9.6/CarlaUE4.sh


export PATH="/home/is/devel/sim/carla/carla:$PATH"

export PYTHONPATH=$PYTHONPATH:/home/is/devel/sim/carla/carla-0.9.11/PythonAPI/carla/dist/carla-0.9.11-py3.6-linux-x86_64.egg
# export PYTHONPATH=$PYTHONPATH:/home/is/devel/sim/carla/carla/PythonAPI/carla/dist/carla-0.9.11-py3.6-linux-x86_64.egg
# export CARLA_SERVER=/home/is/devel/sim/carla/carla-0.8.2/CARLA_0.8.2/CarlaUE4.sh
export CARLA_SERVER=/home/is/devel/sim/carla/carla/Unreal/CarlaUE4/Saved/StagedBuilds/LinuxNoEditor/CarlaUE4.sh

# export PYTHONPATH=$PYTHONPATH:/home/is/devel/sim/carla/carla-0.9.10/CARLA_0.9.10/PythonAPI/carla-0.9.10-py2.7-linux-x86_64.egg
# source /raid/02-dev/osrf/ros-melodic/ros_catkin_ws/devel_isolated/setup.bash
# source /raid/02-dev/osrf/ros-melodic/ros_catkin_ws/install_isolated/setup.bash
...
# export OPENCV_ROOT="$HOME/raid/02-dev/cv/opencv/3.4.9/opencv-3.4.9-install-g5c9"
# export LD_LIBRARY_PATH="$HOME/raid/02-dev/cv/opencv/3.4.9/opencv-3.4.9-install-g5c9/lib:$LD_LIBRARY_PATH"
# export PATH="$HOME/raid/02-dev/cv/opencv/3.4.9/opencv-3.4.9-install-g5c9/bin:$PATH"


#For MRPT
# export MRPT_DIR="$HOME/raid/02-dev/lidar/mrpt/mrpt-1.5.9-install-g5c9"
# export LD_LIBRARY_PATH="$HOME/raid/02-dev/lidar/mrpt/mrpt-1.5.9-install-g5c9/lib:$LD_LIBRARY_PATH"
# export PKG_CONFIG_PATH="$HOME/dev/cv/opencv-3.4.9/opencv-3.4.9-install/lib/pkgconfig:PKG_CONFIG_PATH"

# export PCL_DIR="$HOME/raid/02-dev/lidar/pcl/pcl-pcl-1.9.1-install-g5c9"
# export LD_LIBRARY_PATH="$HOME/raid/02-dev/lidar/pcl/pcl-pcl-1.9.1-install-g5c9/lib:$LD_LIBRARY_PATH"

...
export PATH="/bin:/usr/bin:/usr/local/bin:${PATH}:/usr/local/cuda-10.2/bin"
...
export LIBRARY_PATH="/vault/Downloads/nvidia/10.2/TensorRT-7.2.1.6/lib:$LIBRARY_PATH"
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/vault/Downloads/nvidia/10.2/TensorRT-7.2.1.6/lib:/usr/local/cuda-10.2/extras/CUPTI/lib64"

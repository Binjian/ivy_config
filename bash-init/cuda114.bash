...
source $HOME/bash-init/switch-cuda/switch-cuda.sh 11.4
...
export PATH="/bin:/usr/bin:/usr/local/bin:${PATH}:/usr/local/cuda-11.4/bin"
...
export LIBRARY_PATH="/usr/local/cuda-11.4/lib64:/usr/local/cuda-11.4/extras/CUPTI/lib64:$LIBRARY_PATH"
export CPATH="/usr/local/cuda-11.4/lib64:/usr/local/cuda-11.4/include:$CPATH"

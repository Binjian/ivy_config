...
# source $HOME/dev/ros_melodic/catkin_ws_isolated/devel_isolated/setup.bash
...
# #For RVIZ now local build is contrained to use ogre-1-9-0 since melodic official support only that view.
# export PKG_CONFIG_PATH="$HOME/dev/misc/ogre/ogre-1.12.2-install/lib/pkgconfig:${PKG_CONFIG_PATH}"

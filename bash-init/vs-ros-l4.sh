...
# source $HOME/raid/02-dev/nio/ws-Release/20200503/l4_ws/devel/setup.bash
...
export OPENCV_ROOT=$HOME/dev/cv/opencv-3.4.9/opencv-3.4.9-g5c9-install
export LD_LIBRARY_PATH="$HOME/dev/cv/opencv-3.4.9/opencv-3.4.9-g5c9-install/lib:$LD_LIBRARY_PATH"
export PATH="$HOME/dev/cv/opencv-3.4.9/opencv-3.4.9-g5c9-install/bin:$PATH"


# #For MRPT
# export MRPT_DIR="$HOME/dev/lidar/mrpt/mrpt-1.5.9-c9-install"
# export LD_LIBRARY_PATH="$HOME/dev/lidar/mrpt/mrpt-1.5.9-c9-install/lib:$LD_LIBRARY_PATH"
# # export PKG_CONFIG_PATH="$HOME/dev/cv/opencv-3.4.9/opencv-3.4.9-install/lib/pkgconfig:PKG_CONFIG_PATH"

# export PCL_DIR="$HOME/dev/lidar/pcl/pcl-pcl-1.9.1-c9-install"
# export LD_LIBRARY_PATH="$HOME/dev/lidar/pcl/pcl-pcl-1.9.1-c9-install/lib:$LD_LIBRARY_PATH"
